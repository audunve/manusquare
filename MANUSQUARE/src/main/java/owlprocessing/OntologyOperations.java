...
//	}
     ...
     *
     * @param o the input OWL ontology from which classes and superclasses
     *          should be derived
     ...
     *
     * @param o the input OWL ontology from which classes and subclasses
     *          should be derived
     ...
     * ontologies have
     *
     * @param ontoFile1: an ontology file
     * @param ontoFile2: an ontology file
